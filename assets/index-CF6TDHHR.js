...
aut aut aut maxime quia temporibus ut omnis`}],Mc=({post:e})=>{const t=Tc.filter(i=>i.postId===e.id);return R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),R.jsx(zc,{user:Lc.find(i=>i.id===e.userId)})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),t.length===0?R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}):R.jsx(Pc,{comments:t})]})},Rc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Mc,{post:t},t.id))}),Dc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:Cc})]});em(document.getElementById("root")).render(R.jsx(Dc,{}));
